...
class ActivityPicker extends StatefulWidget {
  final Function(String, String) onSelectActivity;
      ...
      setState(() {
        ...
        if (widget.selectedActivity == activityName) {
          widget.onSelectActivity(
              '전체', 'category_rounded'); // '전체'와 그에 해당하는 아이콘을 선택
        }
      });
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (activity['activity_name'] == '전체') {
                      return ListTile(
                        ...
                        onTap: () {
                          widget.onSelectActivity(activity['activity_name'],
                              activity['activity_icon']); // 선택된 액티비티 전달
                        },
                      );
                    }
