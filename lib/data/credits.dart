...
const List<Map<String, dynamic>> creditList = [
  ...
  },
  {
    ...
    'description': '이 어플리케이션은 auto_size_text 라이브러리를 사용했어요.',
    'link': 'https://pub.dev/packages/auto_size_text',
  },
  {
    'category': '오픈 소스 라이브러리',
    'title': 'just_the_tooltip',
    'description': '이 어플리케이션은 just_the_tooltip 라이브러리를 사용했어요.',
    'link': 'https://pub.dev/packages/just_the_tooltip',
  },
  {
    'category': '오픈 소스 라이브러리',
    'title': 'in_app_review',
    'description': '이 어플리케이션은 in_app_review 라이브러리를 사용했어요.',
